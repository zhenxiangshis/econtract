<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeBehind="Menu_TreeEdit.aspx.cs" Inherits="qihang.admin.Menu.Menu_TreeEdit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="breadcrumb" Runat="Server">
    ...
    <h3 class="page-title">菜单修改 <small>修改管理后台的左侧菜单</small>
    </h3>
    <ul class="breadcrumb">
        <li>
            <i class="icon-home"></i>
        ...
        <div class="span12">
            <div class="portlet box purple">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-sitemap"></i>菜单修改</div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form id="form1" action="Menu_TreeEdit.aspx?id=<% =model.NodeID %>" method="post" class="menu-form form-horizontal form-bordered form-label-stripped">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="txtName" name="txtName" class="m-wrap medium" value="<%=model.Text %>" />
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="txtId" name="txtId" class="m-wrap small tooltips" data-original-title="该父类下子节点的排列顺序号" value="<%=model.OrderID %>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">链接路径</label>
                            <div class="controls">
                                <input type="text" id="txtUrl" name="txtUrl" class="m-wrap span6" value="<%=model.Url %>" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">图标</label>
                            <div class="controls">
                                <i class="<%=model.Comment %>" id="iicon"></i>
                                <a class="btn blue" data-toggle="modal" href="#iconText">浏览</a>
                                <input type="hidden" id="hicon" name="hicon" value="<%=model.Comment %>" />
                            </div>
                        </div>
