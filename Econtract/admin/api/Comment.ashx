...
public class Comment : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        int iTotalRecords = System.Convert.ToInt32(DbHelperSQL.ExecuteSqlGet("SELECT count(*) FROM [Article_Comment] where  AddTime > '2010' ", ""));
        int iDisplayStart = 1;
        ...
        //获取客户端的Cookie对象
        HttpCookie cok = context.Request.Cookies["Comment_List"];
        ...
        if (!String.IsNullOrEmpty(context.Request.QueryString["sSearch"]))
        {
            ...
            strWhere += " and  Charindex('" + _s + "',Content) > 0 )";
        }
