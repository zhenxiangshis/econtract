var FormComponents = function () {
    ...
    var handleSelec2 = function () {
        ...
        function format(state) {
            ...
            return "<img class='flag' src='media/image/flags/" + state.id.toLowerCase() + ".png'/>&nbsp;&nbsp;" + state.text;
        }
    ...
    var handleInputMasks = function () {
        ...
        $("#mask_currency").inputmask('钪?999.999.999,99', { numericInput: true });  //123456  =>  钪?___.__1.234,56
       
        $("#mask_currency2").inputmask('钪?999,999,999.99', { numericInput: true, rightAlignNumerics: false, greedy: false}); //123456  =>  钪?___.__1.234,56
