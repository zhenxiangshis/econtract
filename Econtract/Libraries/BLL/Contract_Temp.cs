...
namespace BLL
{
	...
	{
		private readonly IContract_Temp dal=DataAccess.CreateContract_Temp();
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Contract_Temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.Contract_Temp> DataTableToList(DataTable dt)
		{
			List<Model.Contract_Temp> modelList = new List<Model.Contract_Temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.Contract_Temp model;
