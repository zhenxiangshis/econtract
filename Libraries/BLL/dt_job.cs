...
namespace BLL
{
	...
	{
		private readonly Idt_job dal=DataAccess.Createdt_job();
		public dt_job()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.dt_job> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.dt_job> DataTableToList(DataTable dt)
		{
			List<Model.dt_job> modelList = new List<Model.dt_job>();
